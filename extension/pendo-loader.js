 ...
 * The agent bundle is ~680KB; queue calls immediately, then defer loading the script until the browser
 ...
 */
(function () {
  // Standard Pendo async install stub — queues API calls until vendor/pendo.js loads.
